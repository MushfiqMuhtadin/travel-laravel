...
<body style="background-color: rgba(147, 250, 171, 0.431)">
    ...
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #0ec962;">

        <div class="collapse navbar-collapse  d-flex justify-content-between">
            <a class="navbar-brand text-dark mx-3" href="{{ route('traveller/dashboard') }}">Welcome Traveller</a>
            <ul class="navbar-nav ">
                ...
                <li class="navbar-brand">
                    <a class="nav-link text-dark" href="{{ url('payment.history/' . $travellerid) }}">Payment History</a>
                </li>
            ...
            <div class="d-flex px-3 ">
                ...
                <h3 class="navbar-brand text-dark"><a class="text-dark"
                        href="{{ url('traveller/dashboard/profile/' . $travellerid) }}">Profile</a></h3>
                <h3 class="navbar-brand text-dark"><a style="color: black" href="{{ route('logout') }}">LOGOUT</a></h3>
                    ...
                    <div style="background-color: #d6f9e06a; width:100% "
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start">
                                <button class="btn btn-success btn-sm mt-2"> <a class="mx-3 text-white fs-5"
