...
@php
    $fullName = $travellerfirstname . ' ' . $travellerlastname;
@endphp
                ...
                <form action="{{ route('checkoutpost') }}" method="post">
                    ...
                    <div class="row mt-3">
                        <div class="col-50">
                            ...
                            <input class="fs-5" type="hidden" id="travellerid" name="travellerid"
                                value="{{ $travellerid }}" readonly>

                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="email" placeholder="john@example.com"
                                value="{{ $travelleremail }}" readonly>

                            <label for="address"><i class="fa fa-address-card-o"></i> Address</label>
                            <input type="text" id="address" name="address" placeholder="542 W. 15th Street"
                                value="{{ $travelleraddress }}" readonly>

                            <label for="phone"><i class="fa fa-address-card-o"></i> phone</label>
                            <input type="text" id="phone" name="phone" value="{{ $travellerphone }}" readonly>

                            <label for="nid"><i class="fa fa-institution"></i> National ID</label>
                            <input type="text" id="nid" name="nid" placeholder="123456789"
                                value="{{ $travellernid }}" readonly>
                        </div>
